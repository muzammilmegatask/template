<section class="header-images">
	<div class="containers">
		<div class="header-heading"> <img src="<?php echo base_url()?>assets/img/header-img1.jpg" alt="Header Images" class="img-responsive header-imgg"> </div>
	</div>
</section>
<div class="layout" style="z-index:4">	
	<div class="content">
		<section id="about" class="about section" style="z-index: 4;">
      <div class="container">
        <header class="section-header">
          <h2 class="section-title in-left wow fadeInLeft" data-wow-delay="0.6s">terms &<span class="text-primary "> Conditions</span> </h2> <strong class="fade-title-left">Terms & <br>Conditions</strong> </header>
      </div>
    </section>
    <section id="about" class="about">
      <div class="container">
        <div class="section-content" style="margin-top: 0em;">
          <div class="row-base2 row">
            <div class="col-md-12">
              <div class="col-about-ab-info wow fadeInRight privacy" data-wow-delay="0.6s">
                      ...
                      <h3>OVERVIEW </h3>
                        ...
                        <p>This website is operated by WEBSITE NAME. Throughout the site, the terms “we”, “us” and “our” refer to WEBSITE NAME. WEBSITE NAME offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                        ...
                        <p>For more detail, please review our <a href="<?php echo base_url()?>refund-policy"> Returns Policy.</a></p>


                        <h3>SECTION 7 - OPTIONAL TOOLS </h3>

                        <p>We may provide you with access to third-party tools over which we neither monitor nor has any control nor input.</p>
                       ...
                       <p> We may also, in the future, offer new services and/or features through the website (including, the release of new tools and resources). Such new features and/or services shall also be subject to these Terms of Service.</p>
                        ...
                        <p>Your submission of personal information through the store is governed by our Privacy Policy. To view our <a href="<?php echo base_url()?>privacy-policy">Privacy Policy.</p> -->



                        <h3>SECTION 10 - PERSONAL INFORMATION </h3>

                        <p>Your submission of personal information through the store is governed by our Privacy Policy. To view our <a href="<?php echo base_url()?>privacy-policy">Privacy Policy.</a></p>
                        ...
                        <p>e do not warrant that the results that may be obtained from the use of the service will be accurate or reliable.</p>
                        ...
                        <p>In no case shall WEBSITE NAME’s, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>


                        <h3>SECTION 14 - INDEMNIFICATION </h3>
                        <p>You agree to indemnify, defend and hold harmless WEBSITE NAME’s and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
                        ...
                        <p>WEBSITE NAME<br>
                        94 Leacresh St. Brampton, Ontario, L6S3K6, Canada <br>
                        support@WEBSITE NAME</p>
